...
urlpatterns = [
    ...
    path('datapackage/list/collaborator/<uuid:collaborator_uuid>/', views.DatapackageListView.as_view(), name='datapackage-list'),
    ...
    path('datapackage/<uuid:uuid>/add_comment/', views.DatapackageAddCommentView.as_view(), name='datapackage-add-comment'),
